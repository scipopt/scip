...
snippet_list = [
    ...
    Snippet("WriteSolutions", "SCIP> write solution stein27.sol", "SCIP> set save _settingsfilename_"),
    Snippet("SaveSettingsOverview", "SCIP> set save _settingsfilename_", "SCIP> display heuristics"),
