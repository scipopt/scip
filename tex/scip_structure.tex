...
%  \tikzstyle{presolverconcept} = [level 2 concept,concept color=f7];
  \tikzstyle{presolverconceptodd} = [level 2 concept,sibling angle=20,level distance=2.35cm,concept color=f7];
  \tikzstyle{presolverconcepteven} = [presolverconceptodd, level distance=1.5cm];
  %\tikzstyle{presolverconcepteven} = [presolverconceptodd];%, level distance=2.5cm];
  \tikzstyle{heurconcepteven} = [level 1 concept, sibling angle=6.69, level distance=5.5cm, concept color=f8, minimum size=.7cm];
  \tikzstyle{heurconceptodd} = [heurconcepteven, level distance=4.5cm, minimum size=.7cm];
...
%  \tikzstyle{nlpiconcept} = [level 2 concept, level distance=1.4cm,concept color=f2];
  ...
  [clockwise from=-90]
  child[level distance=10.75cm] { node[concept, minimum size=1cm] (Heuristic) {Primal\\Heuristic}
    [clockwise from=0]
...
%   child { node[concept] (Variable) {Variable}}
  ...
  child[level distance=9.3cm] { node[concept] (Presolver) {Presolver}
  	[clockwise from=15]
...
%   }
  ...
  child[level distance=8.45cm,minimum size=1.2cm] { node[concept] (ConsHdlr) {Constraint\\Handler}
    [clockwise from=-125]
  ...
  child[level distance=10.5cm] { node[concept] (LP) {LP}
    [clockwise from=115]
  ...
  child[level distance=8.5cm] { node[concept] (Branch) {Branch}
   	[clockwise from=-70]
