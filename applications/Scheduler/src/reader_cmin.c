   ...
   )
{
   ...
   for( j = 0; j < njobs; ++j )
   {
      ...
      for( i = 0; i < nmachines; ++i )
      {
         ...
         SCIP_CALL( SCIPcreateVar(scip, &var, name, 0.0, 1.0, 0.0, SCIP_VARTYPE_BINARY, SCIP_VARIMPLTYPE_NONE,
         ...
         SCIP_CALL( SCIPcreateVar(scip, &var, name, 0.0, (SCIP_Real)lst, 0.0, SCIP_VARTYPE_CONTINUOUS,
