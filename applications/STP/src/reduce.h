...
extern SCIP_RETCODE redLoopStp(SCIP*, const RPARAMS*, GRAPH*, PATH*, PATH*, SCIP_Real*, int*, int*, int*, int*, int*, int*, int*, STP_Bool*, SCIP_Real*);
...
/* reduce_da.c
 */
extern SCIP_RETCODE    reduce_da(SCIP*, GRAPH*, const RPDA*, SCIP_Real*, SCIP_Real*, int*, SCIP_RANDNUMGEN*);
extern SCIP_RETCODE    reduce_dapaths(SCIP*, GRAPH*, SCIP_Real*, int*);
extern SCIP_RETCODE    reduce_daSlackPrune(SCIP*, GRAPH*, int, SCIP_Bool, int*, int*, int*, SCIP_Real*, SCIP_Bool*);
...
extern SCIP_RETCODE    reduce_sdprofitInit1stOnly(SCIP*, const GRAPH*, SDPROFIT**);
