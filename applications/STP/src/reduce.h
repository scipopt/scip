...
extern SCIP_RETCODE    reduce_daSlackPrune(SCIP*, GRAPH*, PATH*, SCIP_Real*, SCIP_Real*, SCIP_Real*, SCIP_Real*, int*, int*, int*, int*,
                               int*, int*, STP_Bool*, STP_Bool*, int*, int, SCIP_Bool, SCIP_Bool*);
