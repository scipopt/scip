...
extern void   graph_path_st_rpcmw(SCIP*, GRAPH*, const SCIP_Real*, SCIP_Real*, int*, int, STP_Bool*);
...
extern SCIP_RETCODE    reduce_simple_pc(SCIP*, GRAPH*, SCIP_Real*, int*, int*, int*);
