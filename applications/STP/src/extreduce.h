...
extern void       extreduce_mstLevelVerticalAddLeafEmpty(SCIP*, const GRAPH*, int, EXTDATA*);
...
extern void       extreduce_mstLevelHorizontalAddEmpty(SCIP*, const GRAPH*, int, const int*, EXTDATA*);
