   ...
   )
{
   ...
   SCIP_CALL( estimatePow(scip, conshdlr, expr, sol, FALSE, &slope, &constant, &islocal, &success) );
   ...
   SCIP_CALL( estimatePow(scip, conshdlr, expr, sol, TRUE, &slope, &constant, &islocal, &success) );
   cr_assert(success);
