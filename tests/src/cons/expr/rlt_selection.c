...
Test(rlt_selection, sepadata, .init = setup, .fini = teardown, .description = "test creation and freeing of separator data")
{
   ...
   cr_expect_eq(sepadata->nvarbilinvars[2], 2, "\nExpected 2 bilinear vars for x2, got %d", sepadata->nvarbilinvars[2]);//4 3 1 2
   cr_expect_eq(sepadata->nvarbilinvars[3], 1, "\nExpected 1 bilinear vars for x3, got %d", sepadata->nvarbilinvars[3]);
   ...
   cr_expect_eq(sepadata->varbilinvars[1][0], x3, "\nExpected varbilinvars[1][0] to be x3, got %s", SCIPvarGetName(sepadata->varbilinvars[1][0]));
   cr_expect_eq(sepadata->varbilinvars[1][1], x2, "\nExpected varbilinvars[1][1] to be x2, got %s", SCIPvarGetName(sepadata->varbilinvars[1][1]));
   cr_expect_eq(sepadata->varbilinvars[2][0], x4, "\nExpected varbilinvars[2][0] to be x4, got %s", SCIPvarGetName(sepadata->varbilinvars[2][0]));
   cr_expect_eq(sepadata->varbilinvars[2][1], x1, "\nExpected varbilinvars[2][1] to be x1, got %s", SCIPvarGetName(sepadata->varbilinvars[2][1]));
   cr_expect_eq(sepadata->varbilinvars[3][0], x1, "\nExpected varbilinvars[3][0] to be x1, got %s", SCIPvarGetName(sepadata->varbilinvars[3][0]));
