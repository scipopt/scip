   ...
   )
{
   ...
   SCIP_CALL( estimateExp(scip, conshdlr, expr, sol, TRUE, &coef, &constant, &local, &success) );
   ...
   SCIP_CALL( estimateExp(scip, conshdlr, expr, sol, FALSE, &coef, &constant, &local, &success) );
