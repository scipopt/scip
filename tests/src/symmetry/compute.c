...
Test(test_compute_symmetry, basic1, .description = "compute symmetry for a simple example with 4 variables and 2 linear constraints")
{
   ...
   /* get symmetry */
   SCIP_CALL( SCIPgetGeneratorsSymmetry(scip, SYM_SPEC_BINARY, 0, FALSE, FALSE,
         &npermvars, &permvars, &nperms, &perms, NULL, NULL) );
...
/* get symmetry */
   SCIP_CALL( SCIPgetGeneratorsSymmetry(scip, SYM_SPEC_BINARY | SYM_SPEC_INTEGER | SYM_SPEC_REAL, 0, FALSE, &npermvars, &permvars, &nperms, &perms, NULL, &binvarsaffected) );
