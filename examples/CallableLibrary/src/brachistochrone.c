 ...
 * 
 * A more detailed description of the model can be found in the brachistochrone folder in:
 *
...
static
SCIP_RETCODE runBrachistochrone(unsigned int n, SCIP_Real* coord)
{
   SCIP* scip;
   ...
   SCIP_Real tol = 1e-4;
   SCIP_CALL( SCIPsetRealParam(scip, "numerics/feastol", tol) );
