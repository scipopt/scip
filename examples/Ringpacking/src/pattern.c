 ...
 *
 *
 * This file implements the handling of patterns. Each pattern has a SCIP_PATTERNTYPE, accessible by
 * SCIPpatternGetPatternType, which indicates whether it is a circular or rectangular pattern.
 */
