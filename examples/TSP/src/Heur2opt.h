...
/*                                                                           */
/* * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * */
#pragma ident "@(#) $Id: Heur2opt.h,v 1.1 2005/03/16 17:02:46 bzfpfend Exp $"

/**@file   heur2opt.h
 * @brief  2-Opt heuristic for TSPs
...
public:
  ...
  /** default constructor */
   Heur2opt(
      ...
      : ObjHeur("2opt", "2-Opt heuristic for TSPs", '2',-1000000, 1, 0, -1, TRUE, TRUE, TRUE),
        graph_(0)
   {
   }
