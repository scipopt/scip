...
/*                                                                           */
/* * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * */
#pragma ident "@(#) $Id: HeurFarthestInsert.h,v 1.4 2005/08/24 17:57:07 bzfpfend Exp $"
...
namespace tsp
{
   ...
   public:
      ...
      HeurFarthestInsert(
         ...
         : ObjHeur("farthestinsert", "farthest insert heuristic for TSPs", 'I',-10000, 0, 0, 0, TRUE, TRUE, FALSE),
           graph_(0)
      {
      }
