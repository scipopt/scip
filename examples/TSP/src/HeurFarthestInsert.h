...
/*                                                                           */
/* * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * */
#pragma ident "@(#) $Id: HeurFarthestInsert.h,v 1.6 2006/01/03 12:22:39 bzfpfend Exp $"
...
namespace tsp
{
   ...
   public:
      ...
      HeurFarthestInsert(
         ...
         : ObjHeur("farthestinsert", "farthest insert heuristic for TSPs", 'I',-10000, 0, 0, 0, TRUE, TRUE, FALSE, FALSE),
           graph_(0)
      {
      }
