...
/*                                                                           */
/* * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * */
#pragma ident "@(#) $Id: cons_xxx.c,v 1.1.2.1 2009/06/19 07:53:31 bzfwolte Exp $"
...
SCIP_RETCODE SCIPcreateConsXxx(
   ...
   int                   nelems,             /**< number of elements in V to be ordered */
   SCIP_VAR***           vars,               /**< n x n matrix of binary variables in linear ordering constraint */
