...
// {
   ...
   if( $17 in statuses ) # SCIP-Jack
   {
      # collect data (line with problem type, original and presolved problem size and simplex iterations)
      type[nsolver,nprobs[nsolver]] = $2;
      conss[nsolver,nprobs[nsolver]] = $6;
      vars[nsolver,nprobs[nsolver]] = $7;
      ...
      iters[nsolver,nprobs[nsolver]] = $13;
      nodes[nsolver,nprobs[nsolver]] = max($14,1);
      time[nsolver,nprobs[nsolver]] = fracceil(max($16,mintime),0.1);
      status[nsolver,nprobs[nsolver]] = $17;
      validline = 1;
   }
