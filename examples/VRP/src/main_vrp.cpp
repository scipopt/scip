...
/*                                                                           */
/* * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * */
#pragma ident "@(#) $Id: main_vrp.cpp,v 1.8.2.1 2011/01/02 11:19:53 bzfheinz Exp $"
                  ...
                  vector<vector<int> >&  distance )
{
   ...
   while ( file ) {
      ...
      if ( key == CAPACITY ) {
         ...
         if ( edge_weight_type != EUC_2D ) {
            cerr << "Error. Data file contains " << EDGE_WEIGHT_TYPE 
                 << " " << edge_weight_type << " and " 
