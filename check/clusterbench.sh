...
for Q in ${split_queue[@]}; do
  ...
  do
    ...
    make testcluster EXECUTABLE=$EXECUTABLE QUEUE=$Q CLUSTERNODES=$n SLURMACCOUNT=scip EXCLUSIVE=true TEST=$TEST SETTINGS=$SETTINGS TIME=601 OUTPUTDIR="${OUTPUTDIR}"
