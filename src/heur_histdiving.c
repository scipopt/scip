...
/*                                                                           */
/* * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * */
#pragma ident "@(#) $Id: heur_histdiving.c,v 1.1 2004/01/24 17:21:10 bzfpfend Exp $"
...
static
DECL_HEURFREE(SCIPheurFreeHistdiving) /*lint --e{715}*/
{  /*lint --e{715}*/
   HEURDATA* heurdata;
...
static
DECL_HEURINIT(SCIPheurInitHistdiving) /*lint --e{715}*/
{  /*lint --e{715}*/
   HEURDATA* heurdata;
...
static
DECL_HEUREXIT(SCIPheurExitHistdiving) /*lint --e{715}*/
{  /*lint --e{715}*/
   HEURDATA* heurdata;
...
static
DECL_HEUREXEC(SCIPheurExecHistdiving) /*lint --e{715}*/
{  /*lint --e{715}*/
   HEURDATA* heurdata;
   LPSOLSTAT lpsolstat;
   VAR* var;
   ...
   )
{
   ...
   CHECK_OKAY( SCIPincludeHeur(scip, HEUR_NAME, HEUR_DESC, HEUR_DISPCHAR, HEUR_PRIORITY, HEUR_FREQ, HEUR_PSEUDONODES,
                  SCIPheurFreeHistdiving, SCIPheurInitHistdiving, SCIPheurExitHistdiving, SCIPheurExecHistdiving,
                  heurdata) );
