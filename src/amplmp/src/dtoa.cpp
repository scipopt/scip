 ...
 */
 ...
 char *
dtoa_r_dmgay(double dd, int mode, int ndigits, int *decpt, int *sign, char **rve, char *buf, size_t blen)
{
 /*	Arguments ndigits, decpt, sign are similar to those
	...
	*/
	...
	ULLong dbhi, dbits, dblo, den, hb, rb, rblo, res, res0, res3, reslo, sres,
		sulp, tv0, tv1, tv2, tv3, ulp, ulplo, ulpmask = 0 /*SV*/, ures, ureslo, zb;
...
#endif
  return dtoa_r_dmgay(dd, mode, ndigits, decpt, sign, rve, 0, 0);
	}
