...
/*                                                                           */
/* * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * */
#pragma ident "@(#) $Id: cons_bounddisjunction.c,v 1.22 2008/09/29 21:24:09 bzfheinz Exp $"
...
{  /*lint --e{715}*/
   ...
   *result = SCIP_FEASIBLE;
   ...
   {
      SCIP_CALL( enforceCurrentSol(scip, conss[c], conshdlrdata->eventhdlr, &cutoff, &infeasible, &reduceddom) );
   }
