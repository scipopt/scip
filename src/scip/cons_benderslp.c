 ...
 *
 * This constraint handler has an enforcement priority that is greater than the integer
 * constraint handler. This means that all LP solutions will be first checked for
 * feasibility with respect to the Benders' decomposition second stage constraints before
 * performing an integrality check. This is part of a multi-phase approach for solving
 * mixed integer programs by Benders' decomposition.
 *
