...
/*                                                                           */
/* * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * */
#pragma ident "@(#) $Id: cons_invarknapsack.c,v 1.17 2004/07/06 17:04:12 bzfpfend Exp $"
...
#if 0
static
DECL_CONSRELAXLP(consRelaxlpInvarknapsack)
{  /*lint --e{715}*/
   errorMessage("method of invarknapsack constraint handler not implemented yet\n");
   abort(); /*lint --e{527}*/
...
#else
#define consRelaxlpInvarknapsack NULL
#endif
   ...
   )
{
   ...
   CHECK_OKAY( SCIPincludeConshdlr(scip, CONSHDLR_NAME, CONSHDLR_DESC,
         ...
         consDeleteInvarknapsack, consTransInvarknapsack, consInitlpInvarknapsack, consRelaxlpInvarknapsack,
