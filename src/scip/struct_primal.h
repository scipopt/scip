...
struct SCIP_Primal
{
   ...
   SCIP_Rational*        upperboundex;       /**< upper (primal) bound of CIP: objective value of best solution or user bound */
   ...
   SCIP_Rational*        cutoffboundex;      /**< store the exact cutoff bound here, if in exact solving mode */
