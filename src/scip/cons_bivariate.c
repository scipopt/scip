   ...
   )
{
   ...
   SCIP_CALL( SCIPcreateEmptyRowConshdlr(scip, row, SCIPconsGetHdlr(cons), rowname, -SCIPinfinity(scip), rhs, FALSE, FALSE /* modifiable */, TRUE /* removable */) );
   ...
   )
{
   ...
   *row = NULL;
   ...
   if( success )
   {
      ...
      SCIP_CALL( SCIPcreateRowConshdlr(scip, row, SCIPconsGetHdlr(cons), "bivaroveresthyperplanecut", 0, NULL, NULL, consdata->lhs - constant, SCIPinfinity(scip), TRUE, FALSE, TRUE) );
   ...
   if( violside == SCIP_SIDETYPE_LEFT )
   {
      ...
      if( consdata->sepaconvexconcave.lineariny )
      {
         ...
         if( success )
         {
            ...
            SCIP_CALL( SCIPcreateRowConshdlr(scip, row, SCIPconsGetHdlr(cons), cutname, 0, NULL, NULL, consdata->lhs - constant, SCIPinfinity(scip), TRUE, FALSE, TRUE) );
      ...
      else
      {
         ...
         if( success )
         {
            ...
            SCIP_CALL( SCIPcreateEmptyRowConshdlr(scip, row, SCIPconsGetHdlr(cons), cutname, consdata->lhs - cutcoeff[3]/cutcoeff[2], SCIPinfinity(scip),
   ...
   else
   {
      ...
      if( consdata->sepaconvexconcave.linearinx )
      {
         ...
         if( success )
         {
            ...
            SCIP_CALL( SCIPcreateRowConshdlr(scip, row, SCIPconsGetHdlr(cons), cutname, 0, NULL, NULL, -SCIPinfinity(scip), consdata->rhs - constant, TRUE, FALSE, TRUE) );
      ...
      else
      {
         ...
         if( success )
         {
            ...
            SCIP_CALL( SCIPcreateEmptyRowConshdlr(scip, row, SCIPconsGetHdlr(cons), cutname, -SCIPinfinity(scip), consdata->rhs + cutcoeff[3]/cutcoeff[2],
                  TRUE, FALSE /* modifiable */, TRUE /* removable */) );
            SCIP_CALL( SCIPaddVarsToRow(scip, *row, 2, SCIPexprtreeGetVars(consdata->f), coefs) );
            if( consdata->z != NULL )
            {
   ...
   )
{
   ...
   SCIP_CALL( SCIPcreateEmptyRowConshdlr(scip, row, SCIPconsGetHdlr(cons), "1ConvexUnderest", -SCIPinfinity(scip), rhs,
         TRUE, FALSE /* modifiable */, TRUE /* removable */) );
