...
{  /*lint --e{715}*/
   ...
   else
   {
      ...
      widthfactor = banditdata->alpha * log1p(1 + banditdata->nselections);
   ...
   )
{
   ...
   uppercb += sqrt(banditdata->alpha * log1p(1.0 + banditdata->nselections) / (SCIP_Real)banditdata->counter[action]);
