...
enum SCIP_Status
{
   ...
   SCIP_STATUS_BESTSOLLIMIT   =  9,     /**< the solving process was interrupted because the solution improvement limit
                                         *   was reached
					 */
   SCIP_STATUS_OPTIMAL        = 10,     /**< the problem was solved to optimality, an optimal solution is available */
   SCIP_STATUS_INFEASIBLE     = 11,     /**< the problem was proven to be infeasible */
   SCIP_STATUS_UNBOUNDED      = 12,     /**< the problem was proven to be unbounded */
   SCIP_STATUS_INFORUNBD      = 13      /**< the problem was proven to be either infeasible or unbounded */
};
