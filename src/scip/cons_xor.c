   ...
   while ( v >= 0 )
   {
      if( consdata->vars[v] == consdata->vars[v+1] ) /*lint !e679*/
      {
         ...
         if( consdata->intvar != NULL )
         {
            ...
            SCIP_CALL( SCIPcreateVarImpl(scip, &newvars[0], varname, lb, ub, 0.0, vartype,
                     SCIPvarGetImplType(consdata->intvar), SCIPvarIsInitial(consdata->intvar),
                     SCIPvarIsRemovable(consdata->intvar), NULL, NULL, NULL, NULL, NULL) );
      ...
      else if( consdata->vars[v] == SCIPvarGetNegatedVar(consdata->vars[v+1]) ) /*lint !e679*/
      {
         ...
         if( consdata->rhs && consdata->intvar != NULL )
         {
            ...
            SCIP_CALL( SCIPcreateVarImpl(scip, &newvar, varname, lb, ub, 0.0, vartype, SCIPvarGetImplType(consdata->intvar),
   ...
   *naddedconss = 0;
   ...
   for (i = 0; i < consdata->nvars; ++i)
   {
      ...
      if ( i == 0 )
      {
         ...
         SCIP_CALL( SCIPcreateVarImpl(scip, &varnn, name, 0.0, 1.0, 0.0, SCIP_VARTYPE_CONTINUOUS, SCIP_VARIMPLTYPE_WEAK,
         ...
         SCIP_CALL( SCIPcreateVarImpl(scip, &varns, name, 0.0, 1.0, 0.0, SCIP_VARTYPE_CONTINUOUS, SCIP_VARIMPLTYPE_WEAK,
                                  SCIPconsIsInitial(cons), SCIPconsIsRemovable(cons), NULL, NULL, NULL, NULL, NULL) );
      ...
      else
      {
         if ( i == consdata->nvars-1 )
         {
            if ( consdata->rhs )
            {
               ...
               SCIP_CALL( SCIPcreateVarImpl(scip, &varss, name, 0.0, 1.0, 0.0, SCIP_VARTYPE_CONTINUOUS, SCIP_VARIMPLTYPE_WEAK,
                                        SCIPconsIsInitial(cons), SCIPconsIsRemovable(cons), NULL, NULL, NULL, NULL, NULL) );
            ...
            else
            {
               ...
               SCIP_CALL( SCIPcreateVarImpl(scip, &varsn, name, 0.0, 1.0, 0.0, SCIP_VARTYPE_CONTINUOUS, SCIP_VARIMPLTYPE_WEAK,
                                        SCIPconsIsInitial(cons), SCIPconsIsRemovable(cons), NULL, NULL, NULL, NULL, NULL) );
   ...
   )
{
   ...
   *naddedconss = 0;
   ...
   for (i = 0; i < consdata->nvars; ++i)
   {
      ...
      SCIP_CALL( SCIPcreateVarImpl(scip, &artvar, name, lb, ub, 0.0, SCIP_VARTYPE_CONTINUOUS, SCIP_VARIMPLTYPE_WEAK,
                               SCIPconsIsInitial(cons), SCIPconsIsRemovable(cons), NULL, NULL, NULL, NULL, NULL) );
