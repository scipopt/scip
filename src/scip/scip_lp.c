...
{
   SCIP_CALL_ABORT( SCIPcheckStage(scip, "SCIPgetRowNumImplIntCols", FALSE, FALSE, FALSE, FALSE, FALSE, FALSE, FALSE, FALSE, TRUE, TRUE, FALSE, FALSE, FALSE, FALSE) );

   return SCIProwGetNumImplIntCols(row, scip->set);
}
