...
{
   SCIP_CALL( SCIPselectVarStrongBranchingRanking(scip, lpcands, lpcandssol, lpcandsfrac, skipdown, skipup, NULL, nlpcands,
      npriolpcands, ncomplete, start, allowaddcons, maxproprounds, probingbounds, forcestrongbranch, bestcand, bestdown,
