...
struct SCIP_Cons
{
   ...
   int                   nconflictlockspos;  /**< number of times, the constraint locked rounding of its variables */
   int                   nconflictlocksneg;  /**< number of times, the constraint locked vars for the constraint's negation */
