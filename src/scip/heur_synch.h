 ...
 *
 * This heuristic takes solutions from somewhere else via the function SCIPheurSynchPassSol(). It
 ...
 * "concsolvers/synch/maxnsols"
 */

/*---+----1----+----2----+----3----+----4----+----5----+----6----+----7----+----8----+----9----+----0----+----1----+----2*/

#ifndef __SCIP_HEUR_SYNCH_H__
#define __SCIP_HEUR_SYNCH_H__
