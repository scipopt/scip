   ...
   )
{
   ...
   *infeas = FALSE;
   ...
   /* nothing to do if var is already fixed to !indvalue */
...
{ /*lint --e{715}*/
   ...
   /* TODO may be we can actually do something in probing / repropagation too */
   ...
   )
{
   ...
   /* SCIPsetConsExprNlhdlrProp(scip, nlhdlr, nlhdlrIntevalPerspective, NULL); */
