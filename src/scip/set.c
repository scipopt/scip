...
#define SCIP_DEFAULT_CONF_POSTPROCESSCONF  TRUE /**< should we postprocess the conflict constraints? */
...
#define SCIP_DEFAULT_CONF_REDUCTION        'r'  /**< which tightening reduction should be used?
   ...
   )
{
  ...
  SCIP_CALL( SCIPsetAddBoolParam(*set, messagehdlr, blkmem,
         ...
         NULL, NULL) );
   SCIP_CALL( SCIPsetAddBoolParam(*set, messagehdlr, blkmem,
         "conflict/postprocessconflicts",
         "should we postprocess the conflict constraints?",
         &(*set)->conf_postprocessconflicts, TRUE, SCIP_DEFAULT_CONF_POSTPROCESSCONF,
         NULL, NULL) );
  SCIP_CALL( SCIPsetAddRealParam(*set, messagehdlr, blkmem,
