...
#define SCIP_DEFAULT_CONF_COEFDIFF         1e9 /**< largest allowed difference of max, min coefficient in a conflict constraint generated bygeneralized resolution */
   ...
   )
{
   ...
   SCIP_CALL( SCIPsetAddBoolParam(*set, messagehdlr, blkmem,
         ...
         NULL, NULL) );
   SCIP_CALL( SCIPsetAddRealParam(*set, messagehdlr, blkmem,
         "conflict/generalresminmaxdiff",
         " largest allowed difference of max, min coefficient in a conflict constraint generated bygeneralized resolution",
         &(*set)->conf_generalresminmaxdiff, FALSE, SCIP_DEFAULT_CONF_COEFDIFF, -1, SCIP_REAL_MAX,
         NULL, NULL) );
   SCIP_CALL( SCIPsetAddCharParam(*set, messagehdlr, blkmem,
         "conflict/useinflp",
