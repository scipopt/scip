...
#define SCIP_DEFAULT_CONF_COEFQUOT        1e9 /**< largest allowed quotient of max, min coefficient in a conflict constraint generated bygeneralized resolution */
   ...
   )
{
   ...
   SCIP_CALL( SCIPsetAddRealParam(*set, messagehdlr, blkmem,
         ...
         " largest allowed quotient of max, min coefficient in a conflict constraint generated bygeneralized resolution",
         &(*set)->conf_generalresminmaxquot, FALSE, SCIP_DEFAULT_CONF_COEFQUOT, -1, SCIP_REAL_MAX,
         NULL, NULL) );
   SCIP_CALL( SCIPsetAddCharParam(*set, messagehdlr, blkmem,
         "conflict/useinflp",
