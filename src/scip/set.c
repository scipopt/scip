...
#define SCIP_DEFAULT_MISC_SHOWDIVINGSTAT  FALSE /**< should detailed statistics for diving heuristics be shown? */
   ...
   )
{
   ...
   SCIP_CALL( SCIPsetAddBoolParam(*set, messagehdlr, blkmem,
            ...
            &(*set)->misc_showdivingstat, FALSE, SCIP_DEFAULT_MISC_SHOWDIVINGSTAT,
            NULL, NULL) );
