   ...
   )
{
   ...
   SCIP_CALL( SCIPsetAddCharParam(*set, messagehdlr, blkmem,
      ...
      SCIP_CALL( SCIPsetAddCharParam(*set, messagehdlr, blkmem,
         ...
         "which tightening reduction should be used? ('o'ff, 'm'ir, 'd'ivision, 'c'oefficient tightening)",
         &(*set)->conf_reductiontechnique, FALSE, SCIP_DEFAULT_CONF_REDUCTION, "omdc",
         NULL, NULL) );
   SCIP_CALL( SCIPsetAddBoolParam(*set, messagehdlr, blkmem,
         "conflict/usesb",
