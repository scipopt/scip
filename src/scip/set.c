...
#define SCIP_DEFAULT_CONF_APPLYCMIR       TRUE  /**< should we apply cmir to strengthen the conflict constraints? */
#define SCIP_DEFAULT_CONF_COEFQUOT        1e6   /**< largest allowed quotient of max, min coefficient in a conflict constraint generated by generalized resolution */
