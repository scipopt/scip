...
#define SCIP_DEFAULT_CONF_MAXCOEFQUOT      1e+6 /**< largest allowed quotient of max, min coefficient in a conflict constraint generated by generalized resolution */
   ...
   )
{
   ...
   SCIP_CALL( SCIPsetAddBoolParam(*set, messagehdlr, blkmem,
         ...
         &(*set)->conf_usegenres, FALSE, SCIP_DEFAULT_CONF_USEGENRES,
         NULL, NULL) );
   SCIP_CALL( SCIPsetAddCharParam(*set, messagehdlr, blkmem,
         "conflict/useinflp",
   ...
   SCIP_CALL( SCIPsetAddCharParam(*set, messagehdlr, blkmem,
      ...
      SCIP_CALL( SCIPsetAddCharParam(*set, messagehdlr, blkmem,
         ...
         &(*set)->conf_reduction, FALSE, SCIP_DEFAULT_CONF_REDUCTION, "om",
         NULL, NULL) );
   SCIP_CALL( SCIPsetAddBoolParam(*set, messagehdlr, blkmem,
  ...
  SCIP_CALL( SCIPsetAddRealParam(*set, messagehdlr, blkmem,
   ...
   SCIP_CALL( SCIPsetAddIntParam(*set, messagehdlr, blkmem,
         ...
         &(*set)->lp_solvedepth, FALSE, SCIP_DEFAULT_LP_MINSOLVEDEPTH, -1, SCIP_MAXTREEDEPTH,
         NULL, NULL) );
   SCIP_CALL( SCIPsetAddCharParam(*set, messagehdlr, blkmem,
         "lp/initalgorithm",
...
{
   SCIP_CALL( SCIPparamsetCheckValuePtrUnique(set->paramset, set) );
