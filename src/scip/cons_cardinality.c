   ...
   if( indvar == NULL )
   {
      ...
      else
      {
         ...
         else
         {
            ...
            SCIP_CALL( SCIPcreateVar(scip, &newvar, varname, 0.0, 1.0, 0.0, SCIP_VARTYPE_BINARY,
   ...
   )
{
   ...
   else
   {
      ...
      else
      {
         ...
         (void) SCIPsnprintf(name, SCIP_MAXSTRLEN, "brleft_#%" SCIP_LONGINT_FORMAT, SCIPgetNNodes(scip));
         ...
         for( v = 0; v < nvars; ++v )
         {
            ...
            else
            {
               ...
               else
               {
                  ...
                  SCIP_CALL( SCIPcreateVar(scip, &var, varname, 0.0, 1.0, 0.0, SCIP_VARTYPE_BINARY,
                                           FALSE, FALSE, NULL, NULL, NULL, NULL, NULL) );
