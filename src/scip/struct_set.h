...
struct SCIP_Set
{
   ...
   SCIP_Real             conf_maxcoefquot;   /**< largest allowed quotient of max, min coefficient in a conflict
   ...
   int                   lp_minsolvedepth;   /**< minimal depth for solving LP at the nodes */
   ...
   SCIP_Bool             concurrent_symmetrybefore; /**< should symmetry be computed before concurrent solving (only relevant when presolvebefore=FALSE)? */
