...
)
{
   ...
   {
      SCIPintervalSetBounds(&varvals[i],
         -infty2infty(SCIPinfinity(scip), infinity, -SCIPvarGetLbLocal(tree->vars[i])),  /*lint --e{666}*/
          infty2infty(SCIPinfinity(scip), infinity,  SCIPvarGetUbLocal(tree->vars[i]))); /*lint --e{666}*/
   }
