 ...
 *
 * This reader allows to parse and write STO files with linear and quadratic constraints and objective,
 ...
 *
 * See http://en.wikipedia.org/wiki/STO_%28format%29 for a description.
 */
