...
/**@file   heur_localbranching-benders.c
...
#define HEUR_NAME             "localbranching-benders"
...
#define EVENTHDLR_NAME         "Localbranchingbenders"
 ...
 */
static
SCIP_DECL_EVENTEXEC(eventExecLocalbranchingbenders)
{
...
static
SCIP_DECL_HEURCOPY(heurCopyLocalbranchingbenders)
{  /*lint --e{715}*/
   assert(scip != NULL);
   assert(heur != NULL);
...
static
SCIP_DECL_HEURFREE(heurFreeLocalbranchingbenders)
{  /*lint --e{715}*/
   SCIP_HEURDATA* heurdata;
...
static
SCIP_DECL_HEURINIT(heurInitLocalbranchingbenders)
{  /*lint --e{715}*/
   SCIP_HEURDATA* heurdata;
...
static
SCIP_DECL_HEUREXEC(heurExecLocalbranchingbenders)
{  /*lint --e{715}*/
   ...
   *result = SCIP_DIDNOTFIND;
   ...
   SCIPdebugMsg(scip, "running localbranchingbenders heuristic ...\n");
   ...
   SCIP_CALL( SCIPcopyLargeNeighborhoodSearch(scip, subscip, varmapfw, "localbranchingbenders", NULL, NULL, 0, heurdata->uselprows,
         heurdata->copycuts, &success, NULL) );

   /* create event handler for LP events */
   eventhdlr = NULL;
   SCIP_CALL( SCIPincludeEventhdlrBasic(subscip, &eventhdlr, EVENTHDLR_NAME, EVENTHDLR_DESC, eventExecLocalbranchingbenders, NULL) );
   if( eventhdlr == NULL )
   {
      /* free hash map */
   ...
   )
{
   ...
   SCIP_CALL( SCIPincludeHeurBasic(scip, &heur,
         ...
         HEUR_MAXDEPTH, HEUR_TIMING, HEUR_USESSUBSCIP, heurExecLocalbranchingbenders, heurdata) );

   assert(heur != NULL);

   /* set non-NULL pointers to callback methods */
   SCIP_CALL( SCIPsetHeurCopy(scip, heur, heurCopyLocalbranchingbenders) );
   SCIP_CALL( SCIPsetHeurFree(scip, heur, heurFreeLocalbranchingbenders) );
   SCIP_CALL( SCIPsetHeurInit(scip, heur, heurInitLocalbranchingbenders) );
   ...
   SCIP_CALL( SCIPaddRealParam(scip, "heuristics/" HEUR_NAME "/minimprove",
         "factor by which localbranching-benders should at least improve the incumbent",
