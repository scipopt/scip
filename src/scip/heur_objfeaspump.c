...
/*                                                                           */
/* * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * */
#pragma ident "@(#) $Id: heur_objfeaspump.c,v 1.11 2005/03/21 11:37:31 bzfpfend Exp $"
...
static
DECL_HEURFREE(heurFreeObjfeaspump) /*lint --e{715}*/
{  /*lint --e{715}*/
   HEURDATA* heurdata;
...
static
DECL_HEURINIT(heurInitObjfeaspump) /*lint --e{715}*/
{  /*lint --e{715}*/
   HEURDATA* heurdata;
...
static
DECL_HEUREXIT(heurExitObjfeaspump) /*lint --e{715}*/
{  /*lint --e{715}*/
   HEURDATA* heurdata;
...
static
DECL_HEUREXEC(heurExecObjfeaspump) /*lint --e{715}*/
{  /*lint --e{715}*/
   HEURDATA* heurdata; 
   ...
   *result = SCIP_DIDNOTFIND;
   ...
   debugMessage("(node %lld) executing objfeaspump heuristic: depth=%d, %d fractionals, dualbound=%g, maxnlpiterations=%lld, maxdivedepth=%d\n",
   ...
   debugMessage("objfeaspump heuristic finished\n");
