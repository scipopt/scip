...
#ifndef __SCIP_HEUR_PROXIMITYBENDERS_H__
#define __SCIP_HEUR_PROXIMITYBENDERS_H__
 ...
 */
EXTERN
SCIP_RETCODE SCIPincludeHeurProximitybenders(
 ...
 */
EXTERN
SCIP_RETCODE SCIPapplyProximitybenders(
...
EXTERN
SCIP_RETCODE SCIPdeleteSubproblemProximitybenders(
   SCIP*                 scip                /** SCIP data structure */
   );
