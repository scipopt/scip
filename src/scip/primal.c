...
/*                                                                           */
/* * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * */
#pragma ident "@(#) $Id: primal.c,v 1.101 2011/01/02 11:10:44 bzfheinz Exp $"
   ...
   )
{
    ...
    */
   if( !set->misc_improvingsols || obj + 0.5 < primal->upperbound || (!SCIPprobIsObjIntegral(prob) && obj < primal->upperbound) )
   {
