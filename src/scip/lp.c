   ...
   )
{
 ...
 SOLVEAGAIN:
   ...
   if( SCIPlpiIsOptimal(lp->lpi) )
   {
       ...
       */
      assert(lpCutoffDisabled(set, prob) || set->exact_enabled || lp->lpsolstat == SCIP_LPSOLSTAT_OBJLIMIT || SCIPsetIsInfinity(set, lp->cutoffbound)
