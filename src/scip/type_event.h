...
#define SCIP_EVENTTYPE_PQNODEINFEASIBLE UINT64_C(0x400000000) /**< A node in the Priority Queue has been proven to be infeasible or was bounded (the node is about to be freed) */
