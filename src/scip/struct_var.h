...
struct SCIP_Var
{
   ...
   int                   nconflictlocksdown; /**< number of locks for rounding down in conflict constraints; if zero */
   int                   nconflictlocksup;   /**< number of locks for rounding up in conflict constraints; if zero */
