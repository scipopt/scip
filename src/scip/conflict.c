   ...
   )
{
   ...
   if( toolong && set->conf_minmaxvars < nnz && nnz > set->conf_maxvarsfac * transprob->nvars )
      return SCIP_OKAY;
...
{/*lint --e{715}*/
   ...
   if( set->conf_sepacuts )
   {
      ...
      SCIP_CALL( SCIPcalcFlowCover(set->scip, refsol, BOUNDSWITCH, ALLOWLOCAL, conflict->proofset->aggrrow,
