   ...
   )
{
   ...
   String desc = fmt::format("parallel presolve for integer and linear optimization (PaPILO) [GitHash: {}]", PAPILO_GITHASH);
#else
   String desc("parallel presolve for integer and linear optimization (PaPILO)");
#endif
