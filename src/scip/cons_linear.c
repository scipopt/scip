...
/*                                                                           */
/* * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * */
#pragma ident "@(#) $Id: cons_linear.c,v 1.255.2.2 2009/06/19 07:53:40 bzfwolte Exp $"
   ...
   )
{
   ...
   for( v = 0; v < consdata->nvars; ++v )
   {
      ...
      SCIPintervalMul(&prod, valint, solvalint);
      SCIPintervalAdd(&activityint, activityint, prod);
   }
