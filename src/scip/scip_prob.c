...
{
   SCIP_CALL_ABORT( SCIPcheckStage(scip, "SCIPgetNTotalBinVars", FALSE, TRUE, FALSE, TRUE, TRUE, TRUE, TRUE, TRUE, TRUE, TRUE, TRUE, TRUE, FALSE, FALSE) );

   switch( scip->set->stage )
   {
      case SCIP_STAGE_PROBLEM:
         return scip->origprob->nbinvars + scip->origprob->nbinimplvars;
      ...
      case SCIP_STAGE_SOLVED:
      case SCIP_STAGE_EXITSOLVE:
         return scip->transprob->nbinvars + scip->transprob->nbinimplvars;
...
{
   SCIP_CALL_ABORT( SCIPcheckStage(scip, "SCIPgetNTotalIntVars", FALSE, TRUE, FALSE, TRUE, TRUE, TRUE, TRUE, TRUE, TRUE, TRUE, TRUE, TRUE, FALSE, FALSE) );

   switch( scip->set->stage )
   {
      case SCIP_STAGE_PROBLEM:
         return scip->origprob->nintvars + scip->origprob->nintimplvars;
      ...
      case SCIP_STAGE_SOLVED:
      case SCIP_STAGE_EXITSOLVE:
         return scip->transprob->nintvars + scip->transprob->nintimplvars;
...
{
   SCIP_CALL_ABORT( SCIPcheckStage(scip, "SCIPgetNTotalContVars", FALSE, TRUE, FALSE, TRUE, TRUE, TRUE, TRUE, TRUE, TRUE, TRUE, TRUE, TRUE, FALSE, FALSE) );

   switch( scip->set->stage )
   {
      case SCIP_STAGE_PROBLEM:
         return scip->origprob->ncontvars + scip->origprob->ncontimplvars;
      ...
      case SCIP_STAGE_SOLVED:
      case SCIP_STAGE_EXITSOLVE:
         return scip->transprob->ncontvars + scip->transprob->ncontimplvars;
