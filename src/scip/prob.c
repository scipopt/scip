...
/*                                                                           */
/* * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * */
#pragma ident "@(#) $Id: prob.c,v 1.60 2005/01/18 09:26:51 bzfpfend Exp $"
   ...
   )
{
   ...
   {
      CHECK_OKAY( SCIPvarUseActiveImplics(prob->vars[v], memhdr, set, stat, lp, branchcand, eventqueue, infeasible) );
   }
