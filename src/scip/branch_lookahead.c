...
/** Keeps only the first candidates and free the remaining ones */
static
 ...
 *  their score scales the number cutoffs on the last layer of a 2-level temporary branching tree with the average gain of
