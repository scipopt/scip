...
#define MAXBRANCHDEPTH MAXDEPTH    /**< maximal allowed value for depth-related parameters such as the maxdepth of a branching rule */
/*
   ...
   )
{
   ...
   SCIP_CALL( SCIPsetAddIntParam(set, messagehdlr, blkmem, paramname, paramdesc,
         &(*branchrule)->maxdepth, FALSE, maxdepth, -1, MAXBRANCHDEPTH,
         NULL, NULL) ); /*lint !e740*/
