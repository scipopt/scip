 ...
 * That is, a good place to call this function is immediately after propConss or after forwardPropExpr if outside propagation.
 */
static
...
//FIXME   SCIP_CALL( bilinearTermsFree(scip, conshdlrdata) );
...
{  /*lint --e{715}*/
    ...
    */
//FIXME   SCIP_CALL( bilinearTermsInsertAll(scip, conshdlr, conss, nconss) );
