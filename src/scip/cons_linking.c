   ...
   )
{
   ...
   SCIP_CALL( SCIPcreateEmptyRowConshdlr(scip, &consdata->row1, SCIPconsGetHdlr(cons), rowname, 0.0, 0.0,
   ...
   SCIP_CALL( SCIPcreateEmptyRowConshdlr(scip, &consdata->row2, SCIPconsGetHdlr(cons), rowname, 1.0, 1.0,
         SCIPconsIsLocal(cons), SCIPconsIsModifiable(cons), SCIPconsIsRemovable(cons)) );
