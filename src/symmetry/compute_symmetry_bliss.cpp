   ...
   )
{
   ...
   *symcodetime = 0.0;
   ...
   SCIP_CALL( computeAutomorphisms(scip, symtype, &G, SCIPgetSymgraphNNodes(graph), nsymvars, maxgenerators,
         perms, nperms, nmaxperms, log10groupsize, symgrouptype, symcodetime) );
