...
#ifndef __SCIP_CONS_UNITTEST_H__
#define __SCIP_CONS_UNITTEST_H__
...
/** creates the handler for unittest constraints and includes xyit in SCIP */
EXTERN
