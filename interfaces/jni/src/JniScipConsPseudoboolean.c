...
JNIEXPORT
jlongArray JNISCIPCONSPSEUDOBOOLEAN(getLinearVarsPseudoboolean)(
   JNIEnv*               env,                /**< JNI environment variable */
   jobject               jobj,               /**< JNI class pointer */
   jlong                 jscip,              /**< SCIP data structure */
   jlong                 jcons               /**< constraint data */
   )
{
   ...
   size = SCIPgetNLinearVarsPseudoboolean(scip, cons);
   ...
   vars = SCIPgetLinearVarsPseudoboolean(scip, cons);
...
JNIEXPORT
jdoubleArray JNISCIPCONSPSEUDOBOOLEAN(getLinearValsPseudoboolean)(
   JNIEnv*               env,                /**< JNI environment variable */
   jobject               jobj,               /**< JNI class pointer */
   jlong                 jscip,              /**< SCIP data structure */
   jlong                 jcons               /**< constraint data */
   )
{
   ...
   vars = SCIPgetLinearValsPseudoboolean(scip, cons);
...
JNIEXPORT
jint JNISCIPCONSPSEUDOBOOLEAN(getNLinearVarsPseudoboolean)(
   JNIEnv*               env,                /**< JNI environment variable */
   jobject               jobj,               /**< JNI class pointer */
   jlong                 jscip,              /**< SCIP data structure */
   jlong                 jcons               /**< constraint data */
   )
{
   ...
   return (jint) SCIPgetNLinearVarsPseudoboolean(scip, cons);
}
 ...
 */
JNIEXPORT
jint JNISCIPCONSPSEUDOBOOLEAN(getTermVarsDataPseudoboolean)(
   JNIEnv*               env,                /**< JNI environment variable */
   jobject               jobj,               /**< JNI class pointer */
   jlong                 jscip,              /**< SCIP data structure */
   jlong                 jcons,              /**< constraint data */
   jobjectArray          jtermvars,          /**< array for all arrays of term variables */
   jintArray             jntermvars          /**< array for number of variable in each term */
   )
{
   SCIPerrorMessage("method getTermVarsDataPseudoboolean is not implemented yet\n");
   JNISCIP_CALL( SCIP_ERROR );
...
JNIEXPORT
jdoubleArray JNISCIPCONSPSEUDOBOOLEAN(getTermValsPseudoboolean)(
   JNIEnv*               env,                /**< JNI environment variable */
   jobject               jobj,               /**< JNI class pointer */
   jlong                 jscip,              /**< SCIP data structure */
   jlong                 jcons               /**< constraint data */
   )
{
   ...
   size = SCIPgetNTermValsPseudoboolean(scip, cons);
   ...
   vars = SCIPgetTermValsPseudoboolean(scip, cons);
...
JNIEXPORT
jint JNISCIPCONSPSEUDOBOOLEAN(getNTermValsPseudoboolean)(
   JNIEnv*               env,                /**< JNI environment variable */
   jobject               jobj,               /**< JNI class pointer */
   jlong                 jscip,              /**< SCIP data structure */
   jlong                 jcons               /**< constraint data */
   )
{
   ...
   return (jint) SCIPgetNTermValsPseudoboolean(scip, cons);
}
