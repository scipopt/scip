...
/**@file   JniScipNodeselRestartdfs.c
 * @ingroup PUBLICMETHODS
 * @brief  JNI SCIP node selector for depth first search with periodical selection of the best node
 * @author Stefan Heinz
...
#include "JniScipNodeselRestartdfs.h"
#include "def.h"
