...
void JNISCIPCONSLINEAR(markDoNotUpgradeConsLinear)(
   JNIEnv*               env,                /**< JNI environment variable */
   jobject               jobj,               /**< JNI class pointer */
   jlong                 jscip,              /**< SCIP data structure */
   jlong                 jcons               /**< constraint data */
 ...
 */
void JNISCIPCONSLINEAR(setUpgradeConsLinear)(
   JNIEnv*               env,                /**< JNI environment variable */
   jobject               jobj,               /**< JNI class pointer */
   jlong                 jscip,              /**< SCIP data structure */
   jlong                 jcons,              /**< constraint data */
   jboolean              jupgradeallowed     /**< allow upgrading? */
   )
{
   SCIP* scip;
   SCIP_CONS* cons;
   ...
   JNISCIP_CALL( SCIPsetUpgradeConsLinear(scip, cons, (jboolean)jupgradeallowed) );
}
