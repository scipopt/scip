...
/**@file   JniScipPresolTrivial.c
 * @ingroup PUBLICMETHODS
 * @brief  JNI SCIP trivial presolver: round fractional bounds on integer variables, fix variables with equal bounds
 * @author Stefan Heinz
...
#include "JniScipPresolTrivial.h"
#include "def.h"
