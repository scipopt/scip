...
if [ "${GITBRANCH}" != "consexpr" ]; then
  ...
  JOBS[6,1]="EXECUTABLE=scipdbgspx_${GITBRANCH}_${RANDOMSEED}/bin/scip BINID=scipdbgspx-${GITBRANCH}_${RANDOMSEED} MEM=6000 QUEUE=opt TEST=mipdev2-solvable TIME=7200 SETTINGS=default"
fi
