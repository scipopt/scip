...
# FORMAT:
#    JOBS[x,y]="EXCLUSIVE=true EXECUTABLE=scipoptspx BINID=scipoptspx-${GITBRANCH} MEM=100 QUEUE=opt TEST=short TIME=10 PERMUTE=2 SETTINGS=default PERFORMANCE=performance"
...
JOBS[6,1]="EXECUTABLE=scipoptspx BINID=scipoptspx-${GITBRANCH} MEM=50000 QUEUE=M620v3 TEST=mipdev-solvable TIME=7200 SETTINGS=default PERFORMANCE=performance"
JOBS[6,2]="EXECUTABLE=scipoptspx BINID=scipoptspx-${GITBRANCH} MEM=50000 QUEUE=M640 TEST=minlpdev-solvable TIME=3600 SETTINGS=minlp_default PERFORMANCE=performance PERMUTE=4"
...
JOBS[7,1]="EXECUTABLE=scipoptspx BINID=scipoptspx-${GITBRANCH} MEM=50000 QUEUE=M630v2 TEST=sapdev-solvable TIME=3600 SETTINGS=sap-next-release-pure-diff PERFORMANCE=performance"
