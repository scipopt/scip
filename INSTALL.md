...
Note that the symmetry codes [Bliss](https://users.aalto.fi/~tjunttil/bliss/), [Sassy](https://github.com/markusa4/sassy), and
...
| `SYM`                  | `bliss`, `sbliss`, `none`, ...     | `SYM=[sbliss, none, ...]`  | choose symmetry handling                                           |
...
| `SYM=none`            | `[none, bliss, sbliss, nauty, snauty, dejavu]` | to choose method for computing symmetries in mixed nonlinear integer programs                  |
